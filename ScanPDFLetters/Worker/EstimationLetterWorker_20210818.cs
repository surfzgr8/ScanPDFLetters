...
{
    internal class EstimationLetterWorker_20210818
    {
        ...
        public EstimationLetterWorker_20210818()
        {
        }

        public EstimationLetterWorker_20210818(StringBuilder sb)
        {
            lines = sb;
...
//            {
      ...
      //  }
        ...
        private void GetPropertyReference(int startPos)
        {
            ...
            rentServiceLetter.PropertyRef = lines.ToString().Substring(startIndex, lines.ToString().IndexOf('\n', startIndex) - startIndex);
        }
